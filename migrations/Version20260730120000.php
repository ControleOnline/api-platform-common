...
final class Version20260730120000 extends TenantAwareMigration
{
    public function getDescription(): string
    {
        return 'Register the ProductsPage route and repoint the manager products menu to it.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'INSERT INTO menu (category_id, menu, route_id, menu_key, app_type, menu_type, route_params, sort_order, enabled)
             ...
             LIMIT 1',
            ['domain' => $this->resolveExecutionDomain(), ...$menu]
        );
