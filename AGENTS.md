...
- A manutencao deve remover integracoes efemeras (`Websocket` e `PushNotification`) abertas ha mais de 24 horas; itens entregues dessas filas devem ser apagados no fluxo de entrega.
