...
namespace ControleOnline\Handler;
...
use ControleOnline\Library\Quote\Exception\EmptyResultsException;
use ControleOnline\Library\Quote\Exception\EntityNotFoundException;
