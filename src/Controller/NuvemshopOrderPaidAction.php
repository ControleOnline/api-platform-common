...
use ControleOnline\Library\Nuvemshop\Client;
use ControleOnline\Library\Nuvemshop\Model\User     as NuvemUser;
use ControleOnline\Library\Nuvemshop\Model\Order    as NuvemOrder;
use ControleOnline\Library\Nuvemshop\Model\Customer as NuvemCustomer;
use ControleOnline\Library\Nuvemshop\Model\Address  as NuvemAddress;
...
class NuvemshopOrderPaidAction extends AbstractController
{
    ...
    private function updateOrder(NuvemOrder $nuvemOrder): PurchasingOrder
    {
      ...
      $action = 'ControleOnline\Controller\ChooseQuoteAction::__invoke';
      $empty  = [];
      $params = [
        'data'    => $order,
