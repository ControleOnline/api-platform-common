...
use ControleOnline\Controller\CreateLogisticAction;
use ControleOnline\Controller\UpdateLogisticAction;
...
#[ApiResource(operations: [new Get(security: 'is_granted(\'ROLE_CLIENT\')'), 
    ...
    filters: [\ControleOnline\Filter\OrderLogisticEntityFilter::class],
...
class OrderLogistic
{
     ...
     * @return  self
     */
    public function setStatus(\ControleOnline\Entity\Status $status)
    {
        $this->status = $status;
        return $this;
    }
