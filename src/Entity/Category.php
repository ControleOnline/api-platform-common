...
class Category
{
     ...
     * @Groups({"category_read", "company_expense_read","menu_read","invoice_read"})
     */
     ...
     * @Groups({"menu_read","category_read", "category_write", "company_expense_read", "queue_read","invoice_read"})
     * @Assert\NotBlank
     ...
     * @Groups({"category_read", "category_write","menu_read","queue_read","invoice_read"})
     * @Assert\NotBlank
     * @Assert\Type(type={"string"})
     */
     ...
     * @Groups({"category_read", "category_write", "company_expense_read", "category_write","menu_read","queue_read","invoice_read"})   
     * @Assert\Type(type={"string"})
     */
