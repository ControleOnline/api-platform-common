...
use ControleOnline\Filter\SalesOrderEntityFilter;
 ...
 *         "get" ={ 
 *             "attributes"    ={"filters"={ControleOnline\Filter\SalesOrderEntityFilter::class}}, 
 ...
 *           "controller"    =ControleOnline\Controller\GetCompetitorAction::class,
 *         }, 
 *         "route_time"={
 *           "access_control"="is_granted('ROLE_ADMIN') or (is_granted('ROLE_CLIENT') and previous_object.canAccess(user))",
 *           "method"        ="PUT",
 *           "path"          ="/sales/orders/{id}/route/time",
 *           "controller"    =ControleOnline\Controller\ChooseRouteTimeAction::class,
 *         },  
 *         "alter_quote"={
 *           "access_control"="is_granted('ROLE_ADMIN') or (is_granted('ROLE_CLIENT') and previous_object.canAccess(user))",
 *           "method"        ="PUT",
 *           "path"          ="/sales/orders/{id}/alter/quote",
 *           "controller"    =ControleOnline\Controller\AlterQuoteAction::class,
 *         }, 
 *         "get_tag"  ={
 *           "security"    ="is_granted('IS_AUTHENTICATED_ANONYMOUSLY')", 
 *           "method"        ="GET",
 *           "path"          ="/carrier_tags/{id}/download-tag",
 *           "controller"    =ControleOnline\Controller\GetCarrierTagAction::class,
 *         }, 
 *         "add_address"={
 *           "access_control"="is_granted('ROLE_CLIENT')",
 *           "method"        ="PUT",
 *           "path"          ="/sales/orders/{id}/add-address",
 *           "controller"    =ControleOnline\Controller\ChangeAddressAction::class,
 *         },
 *         "get_status"  ={
 *           "access_control"="is_granted('ROLE_CLIENT')",
 *           "method"        ="GET",
 *           "path"          ="/sales/orders/{id}/detail/status",
 *           "controller"    =ControleOnline\Controller\GetSalesStatusAction::class,
 *         },
 *         "create_dacte"  ={
 *           "access_control"="is_granted('ROLE_CLIENT')",
 *           "method"        ="POST",
 ...
 *           "controller"    =ControleOnline\Controller\GetSalesOrderSummaryAction::class,
 *         },
 *         "get_quotation" ={
 *           "access_control"="is_granted('ROLE_ADMIN') or (is_granted('ROLE_CLIENT') and previous_object.canAccess(user))",
 *           "method"        ="GET",
 *           "path"          ="/sales/orders/{id}/detail/quotation",
 *           "controller"    =ControleOnline\Controller\GetSalesOrderQuotationAction::class,
 *         },
 ...
 *           "controller"    =ControleOnline\Controller\GetSalesOrderInvoiceAction::class,
 *         },
 *         "update_status"={
 *            "access_control"="is_granted('ROLE_CLIENT')",
 *            "method"        ="PUT",
 *            "path"          ="/sales/orders/{id}/update-status",
 *            "controller"    =ControleOnline\Controller\UpdateSalesStatusAction::class,
 *         },
 *         "remove_invoice"={
 *            "access_control"="is_granted('ROLE_CLIENT')",
 *            "method"        ="PUT",
 *            "path"          ="/sales/orders/{id}/remove-invoice-tax",
 *            "controller"    =ControleOnline\Controller\RemoveInvoiceTaxAction::class,
 *         }, 
 *         "update_dacte"={
 *            "access_control"="is_granted('ROLE_CLIENT')",
 *            "method"        ="PUT",
 *            "path"          ="/sales/orders/{id}/detail/update-dacte",
 *            "controller"    =ControleOnline\Controller\UpdateSalesOrderDacteAction::class,
 *         },
 *         "update_deadline"={
 *            "access_control"="is_granted('ROLE_CLIENT')",
 *            "method"        ="PUT",
 *            "path"          ="/sales/orders/{id}/detail/update-deadline",
 *            "controller"    =ControleOnline\Controller\UpdateSalesOrderDeadlineAction::class,
 *         },
 *         "update_remote"={
 *            "method"        ="PUT",
 *            "path"          ="/sales/orders/{id}/detail/update-remote",
 *            "controller"    =ControleOnline\Controller\UpdateSalesOrderRemoteAction::class,
 *         },
 *         "update_fields"         ={
 *           "access_control"="is_granted('ROLE_CLIENT')",
 ...
 * )
 * @ApiFilter(
 *   ControleOnline\Filter\SalesOrderEntityFilter::class
 * )
 */
...
class SalesOrder extends Order
{
     ...
     * @return Order
     */
    public function addAInvoiceTax(\ControleOnline\Entity\SalesOrderInvoiceTax $invoice_tax)
    {
     ...
     * @param \ControleOnline\Entity\SalesOrderInvoiceTax $invoice_tax
     */
    public function removeInvoiceTax(\ControleOnline\Entity\SalesOrderInvoiceTax $invoice_tax)
    {
     ...
     * @return People
     */
    public function addInvoice(\ControleOnline\Entity\SalesOrderInvoice $invoice)
    {
     ...
     * @param \ControleOnline\Entity\SalesOrderInvoice $invoice
     */
    public function removeInvoice(\ControleOnline\Entity\SalesOrderInvoice $invoice)
    {
