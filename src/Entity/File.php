...
class File
{
     ...
     * @Groups({"file:read","product_file:read","file_item:read","product_details:read","contract:read","model:read","people:read"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255, nullable=false)
     * @Groups({"file:read","product_file:read","file_item:read","product_details:read","file:write","contract:read","model:read","people:read"})
     * @Assert\NotBlank
     */
