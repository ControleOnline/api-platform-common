...
class File
{
    #[Groups(['file:read', 'spool:read', 'order_details:read', 'order_file:read', 'order:write', 'category:read', 'product_category:read', 'order_product:read', 'product_file:read', 'product:read', 'spool_item:read', 'file_item:read', 'contract:read', 'model:read', 'people:read', 'people_link:read', 'people_media:read'])]
    #[Column(type: 'integer', nullable: false)]
    #[Id]
    #[GeneratedValue(strategy: 'IDENTITY')]
    private int $id = 0;

    #[Groups(['file:read', 'spool:read',  'order_details:read', 'order_file:read', 'order:write', 'category:read', 'product_category:read', 'order_product:read', 'product_file:read', 'product:read', 'spool_item:read', 'file_item:read', 'file:write', 'contract:read', 'model:read', 'people:read', 'people_link:read', 'people_media:read'])]
    #[NotBlank]
    ...
    #[Groups(['file:read', 'spool:read',  'order_details:read', 'order:write', 'category:read', 'product_category:read', 'order_product:read', 'product_file:read', 'product:read', 'spool_item:read', 'file_item:read', 'file:write', 'contract:read', 'model:read', 'people:read', 'people_link:read', 'people_media:read'])]
    #[NotBlank]
    ...
    #[Groups(['file:read', 'file_item:read', 'file:write', 'product_file:read', 'people:read', 'people_link:read', 'people_media:read'])]
