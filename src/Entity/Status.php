...
class Status
{
     ...
     * @Groups({ "contract:read", "task:read","display_queue:read","display:read","order_product_queue:read","order:read","order_details:read","order:write", "invoice:read", "status:read","status:write", "order_detail_status:read", "logistic:read","queue:read", "queue_people_queue:read"})
     */
