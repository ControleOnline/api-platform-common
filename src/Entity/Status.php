...
class Status
{
     ...
     * @Groups({ "contract:read", "task:read","display:read","order:read","order_details:read","order:write", "invoice:read", "status:read","status:write", "order_detail_status:read", "logistic:read","queue:read", "queue_people_queue:read"})
     */
