...
use ControleOnline\Controller\GetDeliveryGroupTaxNamesAction;
use ControleOnline\Controller\GetTablesAction;
use ControleOnline\Controller\UpdateDeliveryGroupTaxPriceAction;
...
#[ApiResource(
    operations: [
        ...
        new Put(
            ...
            requirements: ['id' => '^\\d+$'],
            security: 'is_granted(\'edit\', object)',
            controller: 'ControleOnline\\Controller\\CopyDeliveryGroupTaxesAction'
        ), new Put(
