---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/api-platform-common, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/api-platform-common`.
...
- Checkout local: `api-community/modules/controleonline/common`
